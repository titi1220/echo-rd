    ...
    <main className="mx-auto grid max-w-7xl gap-8 px-4 py-10 sm:px-6 md:grid-cols-[.9fr_1.1fr] lg:px-8">
      <section>
        ...
        <div className="mt-8 grid gap-4">
          <div className="flex gap-4 rounded-2xl bg-white p-5 ring-1 ring-slate-200"><Mail className="text-royal" /><div><p className="font-black">Correo electrónico</p><p className="text-slate-600">ayuda@echord.do</p></div></div>
      ...
      <form className="grid gap-4 rounded-3xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
        ...
        <Field label="Motivo">
          <select className={inputClass}>
            ...
            <option>Corrección de información</option>
          </select>
        </Field>
